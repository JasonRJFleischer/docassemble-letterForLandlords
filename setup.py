...
setup(name='docassemble.letterForLandlords',
      version='0.0.1',
      description=('A docassemble extension.'),
      long_description='# docassemble.letterForLandlords\n\nA docassemble extension.\n\n## Author\n\njrjflei@gmail.com\n\n',
      ...
      zip_safe=False,
      package_data=find_package_data(where='docassemble/letterForLandlords/', package='docassemble.letterForLandlords'),
     )
